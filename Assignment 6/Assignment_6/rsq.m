...
%a: sxq activition matrix
%t: sxq target matrix
%r2: r-squared statistic

%arrange t, a with s rows (features) an q columns (observations)
[s,q]=size(t);
if s>q
    t=t';
    a=a';

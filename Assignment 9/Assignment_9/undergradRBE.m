...
plot(t1(1,:),Atrain(1,:),'*') 
hold off
title(sprintf('Training set with spread=%f |feature 1',bs))
xlabel('targets')
ylabel('activatins')
...
plot(t1(2,:),Atrain(2,:),'*') 
hold off
title(sprintf('Training set with spread=%f |feature 2',bs))
xlabel('targets')
ylabel('activatins')
...
plot(t2(1,:),Atest(1,:),'*') 
hold off
title(sprintf('Test set with spread=%f |feature 1',bs))
xlabel('targets')
ylabel('activatins')
...
plot(t2(2,:),Atest(2,:),'*') 
hold off
title(sprintf('Test set with spread=%f |feature 2',bs))
xlabel('targets')
ylabel('activatins')
